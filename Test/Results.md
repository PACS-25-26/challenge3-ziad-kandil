...
2- For small values of n, parallelizaion doesn't improve the computational time and sometimes it is gets slower due to the communication time between the processes.
